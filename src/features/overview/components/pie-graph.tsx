...
export function PieGraph() {
  ...
  return (
    <Card className='@container/card'>
      <CardHeader>
        <CardTitle>Biểu đồ hình tròn</CardTitle>
        <CardDescription>
          <span className='hidden @[540px]/card:block'>
            Tổng số người truy cập theo trình duyệt trong 6 tháng qua
          </span>
          <span className='@[540px]/card:hidden'>Phân phối trình duyệt</span>
        </CardDescription>
      </CardHeader>
